...
def test_voice_reads_listed_words_as_they_sound(tmp_path):
    ...
    assert speakable("41.3㎡ 신고가", table) == "사십일 쩜 삼제곱미터 신고까"
...
def test_voice_text_spells_numbers_in_korean(tmp_path):
    ...
    cases = {
        ...
        "매매가는 0.97% 올랐고 5.8억, 21.9%": "매매가는 영 쩜 구칠퍼센트 올랐고 오 쩜 팔억, 이십일 쩜 구퍼센트",
        ...
        "35살 1번째 기호 2번 3번 2배 1.5배": "서른다섯 살 첫 번째 기호 이번 세 번 두 배 일 쩜 오배",
        ...
        "서울 아파트값이 1년 새 14.56% 올랐고 계약건수는 940건, 사건은 1건": "서울 아파트값이 일년 새, 십사 쩜 오륙퍼센트 올랐고 계약껀수는 구백사십껀, 사건은 한 껀",
    ...
    assert left == "KTX-이음 1-2호선 3:1 G20 마이너스 영 쩜 영삼퍼센트"
